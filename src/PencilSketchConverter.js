...
import { applyPencilSketchFilter } from './filters/PencilSketchFilter';
import './GhibliImageConverter.css'; // Reuse the existing CSS

const PencilSketchConverter = () => {
  ...
  const handleConvertImage = async () => {
    ...
    try {
      ...
      try {
        ...
        const response = await axios.post(`${API_URL}/filter/pencilsketch`, formData, {
          responseType: 'blob',
        ...
        const dataUrl = await applyPencilSketchFilter(originalImage.file);
  ...
  return (
    <div className="upload-container">
      <div className="ghibli-header">
        <h1 className="upload-title">Pencil Sketch Converter</h1>
        <p className="upload-subtitle">Transform your photos into artistic pencil sketches</p>
      </div>
...
export default PencilSketchConverter;