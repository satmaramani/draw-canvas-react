...
import { applyWarholFilter } from './filters/WarholFilter';
import './GhibliImageConverter.css'; // Reuse the existing CSS

const WarholConverter = () => {
  ...
  const handleConvertImage = async () => {
    ...
    try {
      ...
      try {
        ...
        const response = await axios.post(`${API_URL}/filter/warhol`, formData, {
          responseType: 'blob',
        ...
        const dataUrl = await applyWarholFilter(originalImage.file);
  ...
  return (
    <div className="upload-container">
      <div className="ghibli-header">
        <h1 className="upload-title">Classic Warhol Art Converter</h1>
        <p className="upload-subtitle">Transform your photos into Andy Warhol-inspired pop art</p>
      </div>
...
export default WarholConverter;