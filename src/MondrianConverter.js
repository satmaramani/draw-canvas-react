...
import { applyMondrianFilter } from './filters/MondrianFilter';
...
const MondrianConverter = () => {
  ...
  const handleConvertImage = async () => {
    ...
    try {
      ...
      try {
        ...
        const response = await axios.post(`${API_URL}/filter/mondrian`, formData, {
          responseType: 'blob',
        ...
        const dataUrl = await applyMondrianFilter(originalImage.file);
  ...
  const handleDownload = () => {
    ...
    link.download = 'mondrian-art.png';
  ...
  return (
    <div className="upload-container">
      <div className="ghibli-header">
        <h1 className="upload-title">Mondrian Art Converter</h1>
        <p className="upload-subtitle">Transform your photos into Mondrian-inspired geometric art</p>
      </div>
