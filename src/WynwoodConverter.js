...
import { applyWynwoodFilter } from './filters/WynwoodFilter';
import './GhibliImageConverter.css'; // Reuse the existing CSS

const WynwoodConverter = () => {
  ...
  const handleConvertImage = async () => {
    ...
    try {
      ...
      try {
        ...
        const response = await axios.post(`${API_URL}/filter/wynwood`, formData, {
          responseType: 'blob',
        ...
        const dataUrl = await applyWynwoodFilter(originalImage.file);
  ...
  const handleDownload = () => {
    ...
    link.download = 'wynwood-cartoon.png';
  ...
  return (
    <div className="upload-container">
      <div className="ghibli-header">
        <h1 className="upload-title">Wynwood Cartoon Walking Converter</h1>
        <p className="upload-subtitle">Transform your photos into vibrant Wynwood cartoon style</p>
      </div>
...
export default WynwoodConverter;