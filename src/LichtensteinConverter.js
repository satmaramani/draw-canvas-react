...
import { applyLichtensteinFilter } from './filters/LichtensteinFilter';
import './GhibliImageConverter.css'; // Reuse the existing CSS

const LichtensteinConverter = () => {
  ...
  const handleConvertImage = async () => {
    ...
    try {
      ...
      try {
        ...
        const response = await axios.post(`${API_URL}/filter/lichtenstein`, formData, {
          responseType: 'blob',
        ...
        const dataUrl = await applyLichtensteinFilter(originalImage.file);
  ...
  const handleDownload = () => {
    ...
    link.download = 'lichtenstein-art.png';
  ...
  return (
    <div className="upload-container">
      <div className="ghibli-header">
        <h1 className="upload-title">Lichtenstein Pop Art Converter</h1>
        <p className="upload-subtitle">Transform your photos into Roy Lichtenstein-inspired pop art</p>
      </div>
      ...
      {!originalImage ? (
        ...
        <div className="ghibli-converter-container">
          <div className="image-comparison">
            ...
            {convertedImage && (
              <div className="image-box">
                <h3>Lichtenstein Pop Art Style</h3>
...
export default LichtensteinConverter;