...
import { applyGhibliFilter } from './GhibliFilter';
import './GhibliImageConverter.css';
  ...
  const handleConvertImage = async () => {
    ...
    try {
      ...
      try {
        ...
        const response = await axios.post(`${API_URL}/filter/ghibli`, formData, {
          responseType: 'blob',
        ...
        const dataUrl = await applyGhibliFilter(originalImage.file);
  ...
  return (
    <div className="upload-container">
      <div className="ghibli-header">
        <h1 className="upload-title">Ghibli Style Image Converter</h1>
        <p className="upload-subtitle">Transform your photos into Ghibli-style artwork</p>
      </div>
